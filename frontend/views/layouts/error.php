...
use frontend\assets\GhostErrorAsset;
use yii\bootstrap5\Html;
use yii\web\View;

GhostErrorAsset::register($this);

$errorCode = $this->params['code'];
